...
class TourSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $tours = [
            ...
            [
                'name' => '7 DAYS KILIMANJARO MARANGU ROUTE CLIMB',
                'slug' => '7-days-kilimanjaro-marangu-route-climb',
                'description' => 'Conquer Africa\'s highest peak via the Marangu Route, also known as the "Coca-Cola Route." This is the most popular and comfortable route with hut accommodations, perfect for first-time climbers seeking a well-supported trekking experience.',
                ...
                'tour_type' => 'mountain_trekking',
                'route' => 'Marangu Route',
                'difficulty' => 'moderate',
                'package_destinations' => [
                    ['entity_type' => 'mountain', 'entity_ref' => 'kilimanjaro', 'label' => 'Mount Kilimanjaro'],
                ],
                'conversion_triggers' => ['mountain_climbing', 'kilimanjaro_summit', 'adventure_travel'],
                'featured' => true,
                'status' => 'active',
                'images' => [
                    ...
                    'https://res.cloudinary.com/dqflffa1o/image/upload/v1777468776/warbuck_ggd5wl.jpg'
                ],
                'inclusions' => ['Airport transfers', 'Mountain guide and porters', 'All hut accommodation', 'All meals on mountain', 'Climbing equipment', 'Park fees', 'Rescue fees', 'Certificate of completion'],
                'exclusions' => ['International flights', 'Travel insurance', 'Visa fees', 'Personal expenses', 'Tips and gratuities', 'Alcoholic beverages', 'Personal climbing gear'],
            ],
            [
                'name' => '8 DAYS KILIMANJARO MACHAME ROUTE CLIMB',
                'slug' => '8-days-kilimanjaro-machame-route-climb',
                'description' => 'Tackle Kilimanjaro via the scenic Machame Route, known as the "Whiskey Route." This challenging path offers stunning views, diverse landscapes, and higher success rates for reaching Uhuru Peak through proper acclimatization.',
                'location' => 'Mount Kilimanjaro',
                'duration_days' => 8,
                'base_price' => 3800.00,
                'international_price_min' => 3800.00,
                'international_price_max' => 4800.00,
                'best_season' => 'January to March, June to October',
                'tour_type' => 'mountain_trekking',
                'route' => 'Machame Route',
                ...
                'images' => [
                    ...
                    'https://res.cloudinary.com/dqflffa1o/image/upload/v1777468775/Wildbeest_Migration_vnkbqc.jpg'
                ],
                'inclusions' => ['Airport transfers', 'Mountain guide and porters', 'All camping equipment', 'All meals on mountain', 'Climbing equipment', 'Park fees', 'Rescue fees', 'Certificate of completion'],
                'exclusions' => ['International flights', 'Travel insurance', 'Visa fees', 'Personal expenses', 'Tips and gratuities', 'Alcoholic beverages', 'Personal climbing gear'],
            ],
            [
                'name' => '6 DAYS KILIMANJARO RONGAI ROUTE CLIMB',
                'slug' => '6-days-kilimanjaro-rongai-route-climb',
                'description' => 'Experience Kilimanjaro from the less-traveled northern side via Rongai Route. This remote path offers excellent acclimatization, diverse scenery, and approaches the summit from the north with fewer crowds and unique perspectives.',
                'location' => 'Mount Kilimanjaro',
                'duration_days' => 6,
                'base_price' => 3500.00,
            ...
            [
                'name' => '4 DAYS MOUNT MERU CLIMB',
                'slug' => '4-days-mount-meru-climb',
                'description' => 'Conquer Mount Meru, Tanzania\'s second-highest peak, in this challenging 4-day trek. Perfect acclimatization climb for Kilimanjaro with stunning views, diverse wildlife, and dramatic volcanic landscapes.',
                'location' => 'Mount Meru',
                'duration_days' => 4,
                'base_price' => 1800.00,
                'international_price_min' => 1800.00,
                'international_price_max' => 2400.00,
                'best_season' => 'June to February, avoid March-May rainy season',
                'tour_type' => 'mountain_trekking',
                'route' => 'Momella Route',
                'difficulty' => 'challenging',
                'package_destinations' => [
                    ['entity_type' => 'mountain', 'entity_ref' => 'meru', 'label' => 'Mount Meru'],
                ],
                'conversion_triggers' => ['mountain_climbing', 'meru_summit', 'adventure_travel'],
                'featured' => false,
                'status' => 'active',
                'images' => [
