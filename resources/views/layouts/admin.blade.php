            ...
            <div class="flex items-center gap-2 sm:gap-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                        ...
                        <a href="{{ route('profile') }}" class="flex items-center gap-3 px-6 py-3 text-sm font-bold text-slate-600 hover:bg-slate-50 hover:text-emerald-600 transition-all">
                            <i class="ph ph-user-circle text-xl"></i>
                            View Profile
                        </a>
                        <a href="{{ route('settings.account') }}" class="flex items-center gap-3 px-6 py-3 text-sm font-bold text-slate-600 hover:bg-slate-50 hover:text-emerald-600 transition-all">
