...
<head>
    ...
    <title>Itinerary Ready - Reputable Tours</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="font-size: 14px; color: #4a5568;">Your itinerary for {{ $booking->tour->name ?? 'safari yako' }} is ready.</p>

            <div class="card">
                <div class="card-header">
                    <span class="icon">📋</span>
                    <h4>Itinerary ya Safari - Booking #{{ $booking->id }}</h4>
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $booking->adults + $booking->children }} ({{ $booking->adults }} adults, {{ $booking->children }} children)</span>
                    </div>
                </div>
                
                <div style="margin-bottom: 20px;">
                    <h3 style="color: #006400; margin-bottom: 10px;">Ground Support</h3>
                    <div class="detail-item">
                        <span class="detail-label">Lead Guide:</span>
                        <span class="detail-value">{{ $booking->guide->name ?? 'Unassigned' }}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Lead Driver:</span>
                        <span class="detail-value">{{ $booking->driver->name ?? 'Unassigned' }}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Vehicle:</span>
                        <span class="detail-value">{{ $booking->vehicle->plate_number ?? 'Unassigned' }}</span>
                    </div>
                </div>
                
                <div class="button-container">
                    <a href="{{ route('bookings.invoice', $booking->id) }}" class="invest-button">Download Voucher PDF</a>
                </div>
            </div>

            <div class="special-section">
                <h4><span class="icon">📎</span> Important Information</h4>
                <p>Your voucher/invoice is attached to this email.</p>
                <p>If you need any changes (dietary needs, pickup point, flight details), reply to this email.</p>
            </div>
            ...
            <div class="savings-tips" style="margin-top: 25px; background-color: #f7fafc; padding: 15px; border-left: 5px solid #38a169; border-radius: 10px;">
                <h4 style="color: #2f855a; margin-bottom: 10px;">💡 Itinerary Tips</h4>
                <ul style="font-size: 14px; color: #4a5568; line-height: 1.6; margin-left: 20px;">
                    <li>Read your itinerary carefully</li>
                    <li>Prepare a list of important items to bring</li>
                    <li>Confirm pickup times for each day</li>
                    <li>Contact your guide early</li>
                </ul>
            </div>
            
            <p style="font-size: 14px; color: #4a5568;">We look forward to seeing you on your safari start day!</p>
        ...
        <div class="footer">
            Reputable Tours Itinerary System V1.1.0.2026 | Itinerary sent on {{ now()->format('M d, Y \a\t g:i A') }}
        </div>
    </div>
</body>
</html>
