...
<head>
    ...
    <title>{{ $title ?? "Booking Paid - Reputable Tours" }}</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="font-size: 14px; color: #4a5568;">{{ $message ?? "We are sending this message from Reputable Tours for " . $templateName . "." }}</p>
