...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Create Hero Slide</h1>
        <div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="slide-preview" class="border rounded p-3" style="min-height: 200px; background: url('https://via.placeholder.com/400x200/cccccc/666666?text=Hero+Image') center/cover;">
                        <div class="d-flex flex-column justify-content-center align-items-center h-100 text-center text-white" style="background: rgba(0,0,0,0.5);">
                            ...
                            <p id="preview-subtitle" class="mb-3">Slide subtitle appears here</p>
...
document.getElementById('image_url').addEventListener('input', function(e) {
    ...
    if (e.target.value) {
        ...
        preview.style.backgroundImage = "url('https://via.placeholder.com/400x200/cccccc/666666?text=Hero+Image')";
    }
});
...
// Set initial position from URL parameter
