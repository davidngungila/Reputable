...
class TestEmailWorkingCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'test:email-working {to=davidngungila@gmail.com} {count=1}';
     ...
     * @var string
     */
    protected $description = 'Test email sending with working SMTP configuration';
    ...
    public function handle()
    {
        ...
        $this->info("SMTP: mail.reputabletours.com:465 (SSL)");
        
        // Configure working mail settings
        config([
            'mail.default' => 'smtp',
        ...
        for ($i = 1; $i <= $count; $i++) {
            try {
                ...
                $body .= "To: {$toEmail}\n";
                $body .= "SMTP: mail.reputabletours.com:465 (SSL)\n\n";
